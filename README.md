...
every GPU target upstream CI builds for. The merged, actively-served build lives on
the [`f711-rdna`](https://github.com/DanoPTT/llama.cpp/tree/f711-rdna) branch; this
`master` branch stays a close mirror of upstream.
